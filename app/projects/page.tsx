...
const featuredProjects = [
  {
    ...
    bullets: [
      ...
      "Combined statistical fraud-detection heuristics — Benford's Law first-digit deviation, z-score outlier detection on transaction amounts, and weekend-posting risk weighting — into a single risk score, scoring each transaction High/Medium/Low and surfacing results in an interactive dashboard and flag table",
      "Built an \"Explain\" feature that calls the Groq API (Llama 3.3 70B) to generate a plain-English explanation of why a specific transaction was flagged, making the output usable by non-technical auditors",
      ...
      "Designed a clean upload → dashboard → flagged-transaction drill-down UX for the audit review workflow",
    ],
        ...
        {featuredProjects.map((project, idx) => (
          ...
          >
            ...
            {"tagline" in project && project.tagline && (
              <p className="text-sm font-medium text-amber-800 italic mb-3">{renderTagline(project.tagline)}</p>
            )}
